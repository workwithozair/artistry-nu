    ...
    const fetchData = async () => {
      try {
        ...
        if (tournamentError || !tournamentData) {
          throw tournamentError || new Error("Tournament not found")
        }
        ...
        if (session?.user?.id) {
          ...
          if (submissionData) {
            ...
            setIsRegistered(submissionData.payment_status === "paid")
          }
        }
      } catch (error) {
  ...
  const handleRegister = async () => {
    ...
    if (hasSubmission) {
      if (isRegistered) {
        ...
        router.push(`/dashboard/tournaments/${tournamentId}/payment`)
      }
    } else {
        ...
        <div className="space-y-6">
          <Card>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {hasSubmission && (
                    <Badge variant={isRegistered ? "default" : "secondary"}>  
                      {isRegistered ? "Registered" : "Pending Payment"}
                    </Badge>
                  )}
                </div>
                <div className="space-y-2">
            ...
            <CardFooter>
              ...
              >
                {hasSubmission 
                  ? (isRegistered ? "View Submission" : "Complete Payment") 
                  : "Register Now"}
              </Button>
            </CardFooter>
          </Card>
